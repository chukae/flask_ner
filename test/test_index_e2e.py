...
class E2ETests(unittest.TestCase):
    ...
    def setUp(self):
        self.driver = webdriver.Chrome(executable_path=r'../../../Projects/chromedriver')
        self.driver.get('http://localhost:5000')

    def tearDown(self):
        self.driver.quit()

    def test_browser_title_conatins_app_name(self):
    ...
    def test_page_has_ner_table(self):
        input_element = self._find('input-text')
        submit_button = self._find('find-button')
        input_element.send_keys('Zambia and South Africa share a border')
        submit_button.click()
